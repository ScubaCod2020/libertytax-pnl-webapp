...
export const expenseFields: ExpenseField[] = [
  ...
  },
  {
    ...
    step: 0.1,
    description:
      'Payroll taxes, benefits as % of salaries (10% recommended for optimal operations)',
  },
  ...
  // Miscellaneous (1 field)
  {
    ...
    step: 0.1,
    description:
      'Other miscellaneous expenses as % of gross fees (0-1% recommended for optimal operations)',
  },
];
