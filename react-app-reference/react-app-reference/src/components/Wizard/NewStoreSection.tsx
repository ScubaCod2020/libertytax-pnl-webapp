      ...
      >
        ...
        <FormField label="Gross Tax Prep Fees" helpText="Auto: Returns × Avg Net Fee">
          <CurrencyInput
            ...
            onChange={() => {
              /* read-only auto value; no state write */
            }}
              ...
              <NumberInput
                ...
                placeholder={
                  answers.taxPrepReturns
                    ? Math.round(answers.taxPrepReturns * 0.15).toString()
                    : '240'
                }
                prefix="#"
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.25rem' }}>
              ...
              <input
                ...
                step="1"
                placeholder={
                  effectiveGrossFees ? Math.round(effectiveGrossFees * 0.03).toString() : '6,000'
                }
                value={
              ...
              <input
                ...
                onChange={(e) => {
                  ...
                  if (newPct && effectiveGrossFees) {
                    updateAnswers({
                      discountsAmt: Math.round(effectiveGrossFees * (newPct / 100)),
                    });
                  }
                }}
                style={{
