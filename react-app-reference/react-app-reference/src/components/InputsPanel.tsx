...
export default function InputsPanel(props: InputsPanelProps) {
  ...
  const setFieldValue = (field: ExpenseField, value: number) => {
    const setterMap: any = {
      salariesPct: setSal,
      empDeductionsPct: setEmpDeductions,
      rentPct: setRent,
      telephoneAmt: setTelephone,
      utilitiesAmt: setUtilities,
      localAdvAmt: setLocalAdv,
      insuranceAmt: setInsurance,
      postageAmt: setPostage,
      suppliesPct: setSup,
      duesAmt: setDues,
      bankFeesAmt: setBankFees,
      maintenanceAmt: setMaintenance,
      travelEntAmt: setTravelEnt,
      royaltiesPct: setRoy,
      advRoyaltiesPct: setAdvRoy,
      taxRushRoyaltiesPct: setTaxRushRoy,
      miscPct: setMisc,
    };
  ...
  const renderExpenseFieldWithSlider = (field: ExpenseField) => {
    ...
    return (
      <div key={field.id} style={fieldStyle}>
        ...
        >
          <label
            style={{ fontSize: '0.9rem', fontWeight: 500, color: isLocked ? '#6b7280' : 'inherit' }}
          >
            {field.label}
            {isLocked && ' (Locked)'}
          </label>
    ...
    <div className="card" style={{ minWidth: '420px', maxWidth: '500px' }}>
      ...
      >
        ...
        <div style={{ marginBottom: '0.75rem' }}>
          ...
          >
            <label style={{ fontSize: '0.9rem', fontWeight: 500 }}>Average Net Fee</label>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
              <span style={{ fontSize: '0.8rem', color: '#6b7280' }}>$</span>
              <input
                type="number"
        ...
        <div style={{ marginBottom: '0.75rem' }}>
          ...
          >
            <label style={{ fontSize: '0.9rem', fontWeight: 500 }}>Tax-Prep Returns</label>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
              <span style={{ fontSize: '0.8rem', color: '#6b7280' }}>#</span>
              <input
                type="number"
        ...
        >
          ...
          >
            <label style={{ fontSize: '0.9rem', fontWeight: 500 }}>TaxRush Returns</label>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
              <span style={{ fontSize: '0.8rem', color: '#6b7280' }}>#</span>
              <input
                type="number"
        ...
        <div style={{ marginBottom: '0.75rem' }}>
          ...
          >
            <label style={{ fontSize: '0.9rem', fontWeight: 500 }}>Discounts</label>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.25rem' }}>
                <input
                  type="number"
        ...
        {hasOtherIncome && (
          <div style={{ marginBottom: '0.75rem' }}>
            ...
            >
              <label style={{ fontSize: '0.9rem', fontWeight: 500 }}>Other Income</label>
