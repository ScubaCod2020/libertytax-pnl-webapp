  ...
  return (
    <div className="card" style={{ minWidth: '300px', maxWidth: '350px' }}>
      <div
        ...
        style={{ color: '#0369a1', display: 'flex', alignItems: 'center', gap: '0.5rem' }}
      >
        📈 PY Performance
      </div>
        ...
        <div style={{ marginBottom: '1rem' }}>
          ...
          >
            ...
            <div style={{ flex: 1 }}>
              ...
              <div
                style={{ fontSize: '0.9rem', fontWeight: 'bold', color: pyNetMarginStatus.color }}
              >
                {pct(pyNetMarginPct)}
              </div>
            </div>
            ...
            <div style={{ flex: 1 }}>
              ...
              <div
                style={{
                  fontSize: '0.9rem',
                  fontWeight: 'bold',
                  color: pyCostPerReturnStatus.color,
                }}
              >
