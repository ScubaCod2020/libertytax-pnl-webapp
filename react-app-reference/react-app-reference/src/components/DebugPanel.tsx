  ...
  return (
    ...
    >
      ...
      <div style={{ display: 'flex', gap: 8, marginTop: 8 }}>
        <button onClick={onSaveNow} style={{ fontSize: 12 }}>
          Save now
        </button>

        <button onClick={onDumpStorage} style={{ fontSize: 12 }}>
          Dump
        </button>

        <button onClick={onCopyJSON} style={{ fontSize: 12 }}>
          Copy JSON
        </button>

        <button onClick={onClearStorage} style={{ fontSize: 12 }}>
          Clear key
        </button>

        <button onClick={onShowWizard} style={{ fontSize: 12 }}>
          Wizard
        </button>
      </div>
    </div>
