...
import { getSuggestionProfile, calculateSuggestions } from '../../utils/suggestionEngine';
      ...
      >
        ...
        <div style={{ color: '#475569', lineHeight: 1.5 }}>
          <p style={{ margin: '0 0 0.5rem 0' }}>
            <strong>Suggestion Flow:</strong> Input field suggestions → Calculated result
            suggestions
          </p>
          <p style={{ margin: '0 0 0.5rem 0' }}>
            <strong>💡 Blue badges:</strong> Suggested input values based on{' '}
