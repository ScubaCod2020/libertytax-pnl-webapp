...
export const getAdjustmentStatus = (answers: WizardAnswers): AdjustmentStatus => {
  ...
  return {
    ...
    avgNetFeeStatus:
      adjustments.find((a) => a.field === 'Average Net Fee')?.actualGrowth !== undefined
    ...
    taxPrepReturnsStatus:
      adjustments.find((a) => a.field === 'Tax Prep Returns')?.actualGrowth !== undefined
