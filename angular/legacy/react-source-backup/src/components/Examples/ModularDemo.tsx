  ...
  return (
    <div>
      <AppHeader
        ...
        actions={[
          { label: '📊 View Forecast', onClick: () => console.log('Navigate to forecast'), variant: 'secondary' },
          { label: '⚙️ Settings', onClick: () => console.log('Open settings'), variant: 'secondary' }
        ]}
      />

      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem', padding: '0 1.5rem' }}>
    ...
    <div>
      <AppHeader
        ...
        actions={[
          ...
          { label: '📊 Consolidated Report', onClick: () => console.log('Generate report'), variant: 'secondary' }
        ]}
        breadcrumb={[
...
export function MonthlyForecastView() {
  const monthlyMetrics: PerformanceMetric[] = [
    { id: 'jan', label: 'January', value: 42500, unit: 'currency', context: { period: 'Jan 2024' } },
    { id: 'feb', label: 'February', value: 38200, unit: 'currency', context: { period: 'Feb 2024' } },
  ...
  return (
    <div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '1.5rem', padding: '0 1.5rem' }}>
        <PerformanceCard
