...
export class SettingsService {
  ...
  get settings(): AppSettings { return this._settings$.getValue(); }
  ...
  private read(): AppSettings {
    ...
    return { region: 'CA', storeType: 'existing', taxYear: new Date().getFullYear(), taxRush: true, otherIncome: false };
  }
