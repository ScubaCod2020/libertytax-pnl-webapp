...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, RouterLink, PyIncomeDriversComponent, ProjectedIncomeDriversComponent, TargetIncomeDriversComponent],
  templateUrl: './income-drivers.component.html',
})
export class IncomeDriversComponent { constructor(public appCfg: AppConfigService) {} }
