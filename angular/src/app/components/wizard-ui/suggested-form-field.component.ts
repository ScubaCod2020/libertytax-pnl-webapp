...
@Component({
  ...
  template: `
    <lt-wizard-form-field [label]="label" [helpText]="enhancedHelpText" [required]="required">
      <div class="suggested-field-wrapper">
        ...
        <!-- Suggestion Display -->
        <div *ngIf="hasSuggestion" class="suggestion-container">
          <!-- Suggestion Badge -->
          <div
          ...
          <div *ngIf="isCalculated" class="flow-indicator">←</div>
        </div>
      </div>
