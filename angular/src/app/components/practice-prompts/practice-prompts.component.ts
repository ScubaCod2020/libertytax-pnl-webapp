  ...
  template: `
    <div class="practice-prompts-card">
      <div class="practice-header">
        ...
        <div class="practice-subtitle">Interactive exercises to deepen your P&L understanding</div>
      </div>

      <!-- Progress Bar -->
      <div class="progress-section">
        <div class="progress-label">
          <strong>Progress:</strong> {{ progress.completedCount }}/{{
            progress.totalCount
          }}
          completed
        </div>
        <div class="progress-bar">
          <div class="progress-segments" [attr.data-completed]="progress.completedCount">
            <div
        ...
        <div *ngIf="progress.completionPercentage === 100" class="completion-message">
      ...
      <div class="practice-questions">
        ...
        >
          ...
          <div class="notes-section">
            <label [for]="'notes-' + prompt.id" class="notes-label"> Your notes: </label>
            <textarea
              [id]="'notes-' + prompt.id"
