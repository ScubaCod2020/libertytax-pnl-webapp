@echo off
REM Setup script to configure git commit message template for Windows
REM Run this once to set up the commit template for this repository

echo 🚀 Setting up Git commit message template...
echo.

REM Set the commit template for this repository
